...
$$
\begin{equation} \label{mubar} \bar\mu_1 = \sqrt\frac{|p_1|\Delta\,\lp^2}{|p_2p_3|},
\quad \bar\mu_2 = \sqrt\frac{|p_2| \Delta\,\lp^2}{|p_1p_3|}, \quad
\bar\mu_3 = \sqrt\frac{|p_3|\Delta\,\lp^2}{|p_1p_2|}\, . \end{equation}
$$
...
$$
\begin{equation} \l_i\, =\, \frac{\sgn(p_i)\,\sqrt{|p_i|}}{(4\pi |\gamma|\,
...
\left(\frac{v\pm4}{v\pm2}\cdot\l_1,\f{v\pm2}{v}\cdot\l_2,
v\pm4;\right)+\Psi\left(\frac{v\pm4}{v\pm2}\cdot\l_1,\l_2,
v\pm4;\right)\nonumber\\& +\Psi\left(\f{v\pm2}{v}\cdot\l_1,
\frac{v\pm4}{v\pm2}\cdot\l_2,v\pm4;\right)+\Psi
\left(\f{v\pm2}{v}\cdot\l_1, \l_2,v\pm4;\right)\nonumber
\\&+\Psi\left(\l_1,\frac{v\pm2}{v}\cdot\l_2,
...
& \:\Psi\left(\frac{v\pm2}{v}\cdot\l_1, \frac{v}{v\pm2}\cdot\l_2,v;\right)
+\Psi\left(\frac{v\pm2}{v}\cdot\l_1,\l_2,v; \right)\nonumber \\&
+\Psi\left(\frac{v}{v\pm2}\cdot\l_1,\frac{v\pm2}{v}\cdot\l_2,v;
\right)+\Psi\left(\frac{v}{v\pm2}\cdot\l_1,\l_2,v;\right)\nonumber
\\& +
\Psi\left(\l_1,\frac{v}{v\pm2}\cdot\l_2,v;\right)+\Psi\left(\l_1,\frac{v\pm2}{v}
