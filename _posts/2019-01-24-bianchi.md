...
$$
\begin{equation} \lambda_i\, =\, \frac{\sgn(p_i)\,\sqrt{|p_i|}}{(4\pi |\gamma|\,
...
\left(\frac{v\pm4}{v\pm2}\cdot\lambda_1,\f{v\pm2}{v}\cdot\lambda_2,
v\pm4;\right)+\Psi\left(\frac{v\pm4}{v\pm2}\cdot\lambda_1,\lambda_2,
v\pm4;\right)\nonumber\\& +\Psi\left(\f{v\pm2}{v}\cdot\lambda_1,
\frac{v\pm4}{v\pm2}\cdot\lambda_2,v\pm4;\right)+\Psi
\left(\f{v\pm2}{v}\cdot\lambda_1, \lambda_2,v\pm4;\right)\nonumber
\\&+\Psi\left(\lambda_1,\frac{v\pm2}{v}\cdot\lambda_2,
v\pm4;\right)+\Psi\left(\lambda_1,\f{v\pm4}{v\pm2}\cdot\lambda_2,v\pm4;\right),
\end{align}
$$
