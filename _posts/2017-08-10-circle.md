...
* It solves the diffusion equation. Given 
...
Given a probability distribution from this family $$\theta(x - \mu, t)$$ 
*  maxima of the density specified by $$\mu$$ .
*  width of the density specified by t.
it is natural to ask how we estimate parameters 
...
likelihood estimate is the mean of the observations we seek a ML estimate of $$\mu$$. 
This provides a nice concrete example of how the notion of a 'mean value' 
...
$$\mu = \frac{1}{N} x_n + \frac{2\pi r}{N} \;\;\mathrm{for}\;\; r \in
[0,N-1]$$.
